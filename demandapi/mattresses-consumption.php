...
?>
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">Matteresses Consumption</h4>
    ...
    <h4 class="card-title">Projection</h4>
                                    ...
                                    <?php if (isset($subSubRawMaterial['Sub Raw Materials'])): ?>
                                        <?php foreach ($subSubRawMaterial['Sub Raw Materials'] as $subSubSubRawMaterial): ?>
                                            <tr>
                                                ...
                                                <td><?php echo $subSubSubRawMaterial['RM Description']; ?></td>
                                                <td><?php echo $subSubSubRawMaterial['uom']; ?></td>
                                                <td><?php echo $subSubSubRawMaterial['Multiplied_Values']['July/2023']; ?></td>
                                                <td><?php echo $subSubSubRawMaterial['Multiplied_Values']['August/2023']; ?></td>
                                                <td><?php echo $subSubSubRawMaterial['Multiplied_Values']['September/2023']; ?></td>
                                                <td><?php echo $subSubSubRawMaterial['Multiplied_Values']['October/2023']; ?></td>
                                                <td><?php echo $subSubSubRawMaterial['Multiplied_Values']['November/2023']; ?></td>
                                                <td><?php echo $subSubSubRawMaterial['Multiplied_Values']['December/2023']; ?></td>
                                                <td><?php echo $subSubSubRawMaterial['Multiplied_Values']['January/2024']; ?></td>
                                                <td><?php echo $subSubSubRawMaterial['Multiplied_Values']['February/2024']; ?></td>
                                                <td><?php echo $subSubSubRawMaterial['Multiplied_Values']['March/2024']; ?></td>
                                                <td><?php echo $subSubSubRawMaterial['Multiplied_Values']['April/2024']; ?></td>
                                                <td><?php echo $subSubSubRawMaterial['Multiplied_Values']['May/2024']; ?></td>
                                                <td><?php echo $subSubSubRawMaterial['Multiplied_Values']['June/2024']; ?></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php else: ?>
                                        <tr>

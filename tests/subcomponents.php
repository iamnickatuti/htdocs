...
$query = "
SELECT
  skus1.name AS 'Sub Component One',
  skus1.description AS 'Sub Component One Description',
  skus.name AS 'Component One',
  skus.description AS 'Component_Description One',
